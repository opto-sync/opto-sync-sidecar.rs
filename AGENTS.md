...
Canonical `opto-sync-sidecar.rs` for [`opto-sync`](https://github.com/opto-sync).
...
- This repository: https://github.com/opto-sync/opto-sync-sidecar.rs
...
- Package / service name: `opto-sync-sidecar`
